...
| 6 | E7 | What integrity guarantees does Git alone provide? | `EventChain`, Git | Detection rate, diagnostic precision |
| 7 | E6 | Does the pipeline scale to 500K+ real event chains? | `DataImporter`, `EventChain` | Chain integrity at scale |
...
### 4.7 E7: Git-Only Baseline Comparison --- Detailed Methodology
...
All seven experiments passed. Table 5 presents a summary of each experiment's identifier, pass/fail status, wall-clock duration in milliseconds, and the primary metric. The total runtime for E1--E5 and E7 is 139 ms; E6 contributes 238,490 ms ($\sim$3 minutes 58 seconds) for the ingestion and integrity verification of 5,080,714 events across 495,671 chains.
...
### 5.3 E7: Git-Only Baseline Results
