...
> **Version:** v0.6.0-alpha (pre-submission revision: test counts updated, E36 simulated, citations added)  
...
*Code-paper alignment: 1,651 tests passing (91% coverage, 106 files), 9 theorems, 35-page paper.*
