...
This appendix provides the full complexity-class discussion and the complete comparison with Event Calculus, Situation Calculus, and Description Logic that were compressed from Section~\ref{subsec:precondition-language} and Section~\ref{subsec:event-frameworks}.
