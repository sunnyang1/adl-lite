...
This appendix provides the complete syntax and operational semantics of the ADL Lite precondition language, together with the ontology-to-schema mapping and a concrete event-encoding example that were compressed from Section~\ref{subsec:document-model} and Section~\ref{subsubsec:precondition-language}.
