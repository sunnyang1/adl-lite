...
S3. PROV-O & 12 & 9 & 6 & 23 & 53$^a$ \\
S4. Git-only & 11 & 12 & 8 & 14 & 45 \\
\bottomrule
\multicolumn{6}{@{}l@{}}
\footnotesize $^a$PROV-O total (53 LOC, v0.6.0-alpha) includes three helper lines (e.g., \texttt{QualifiedName} declaration) not itemised in the per-task columns; per-task values sum to 50.
\end{tabular}
\end{table}
